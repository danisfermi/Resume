...
My resume, based on the famous Deedy-Resume [https://github.com/deedy/Deedy-Resume]
It uses MacFonts, so make sure you have the licese to Mac OS X Fonts.
(Description from Original Github Repo by Debosmita Das)
